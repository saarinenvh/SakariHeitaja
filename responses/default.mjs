...
export const sakariResponses = ["Pää kii aki!", "Turhaa mua syytät, salee topin vika.", "Hyvä vadee!", "Mä oon a;ina oikeessa!", "NO MITÄ???", "Mitä sä mua huutelet??", "Huoh....", "Hiljaa saatana!", "Eiku C-Line!"];
